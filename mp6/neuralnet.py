...
class NeuralNet(torch.nn.Module):
    def __init__(self, lrate,loss_fn,in_size,out_size):
        ...
        self.hidden = nn.Sequential(nn.Linear(in_size,128),nn.LayerNorm(128), nn.ELU(), nn.Linear(128,128), nn.LayerNorm(128), nn.ELU(),nn.Linear(128,out_size))
    ...
    def set_parameters(self, params):
        ...
        """
        tmp = ['self.hidden.0.weight', 'self.hidden.0.bias', 'self.hidden.1.weight', 'self.hidden.1.bias', 'self.hidden.3.weight', 'self.hidden.3.bias', 'self.hidden.4.weight', 'self.hidden.4.bias', 'self.hidden.6.weight', 'self.hidden.6.bias']
